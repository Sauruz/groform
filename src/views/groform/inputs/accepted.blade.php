<div class="form-check">
    ...
    <input name="{{$input['id']}}"
           ...
           @if(old(Gromatics\Groform\Groform::arrayToDotNotation($input['id'])))
               @if( old(Gromatics\Groform\Groform::arrayToDotNotation($input['id'])) == 'on') checked @endif
           @elseif(isset($model) && Gromatics\Groform\Groform::accessProperty($model, $input['id']) == 1)
               checked
        @endif>
